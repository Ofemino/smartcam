...
namespace SmartCamClient
{
    ...
    public class AsynchronousClient
    {
        ...
        public static void StartClient(string stringToSend)
        {
        ...
        private static void ReceiveCallback(IAsyncResult ar)
        {
            try
            {
                ...
                try
                {
                    ...
                    int bytesRead = client.EndReceive(ar, out se);
        ...
        private static void Send(Socket client, String stringToSend)
        {
            // Convert the string data to byte data using ASCII encoding.
            byte[] byteData = Encoding.ASCII.GetBytes(stringToSend);
